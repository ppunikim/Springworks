...
<body>
	...
	<div class="w3-container detail-flex">
		...
		<div class="detail table_all">
			<h6>도서명: <a href="${BOOK.link}" target=new>${BOOK.title}</a></h6>
			<p>ISBN : ${BOOK.isbn}</p>
			<p>저자: ${BOOK.author}</p>
		...
		<div class="btn-box">
			<a href="${rootPath}/books/list" class="list btn-neo">리스트로 gogo</a> <a
				href="${rootPath}/books/${BOOK.isbn}/update" class="update btn-neo">수정</a>
