...
<script src="${rootPath}/static/js/input.js?ver=2022-06-09-001"></script>
</head>
...
<body>
	...
	<nav>
		<ul>
			...
			<li><a href="${rootPath}/diary/write">오늘의 일기</a></li>
	...
	<section class="main">
		<c:choose>
			<c:when test="${LAYOUT == 'DIARY'}">
				<%@ include file="/WEB-INF/views/diary/write.jsp" %>
			</c:when>
